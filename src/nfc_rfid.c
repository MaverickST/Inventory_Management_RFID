...
void nfc_config_blocking(nfc_rfid_t *nfc)
{
    ...
    count = i2c_write_blocking(_i2c, ADDRESS_SLAVE_MFRC522, bufC1, 2, false);
    count = i2c_write_blocking(_i2c, ADDRESS_SLAVE_MFRC522, bufC2, 2, false);
    count = i2c_write_blocking(_i2c, ADDRESS_SLAVE_MFRC522, bufC3, 2, false);
    ...
    count = i2c_write_blocking(_i2c, ADDRESS_SLAVE_MFRC522, buf1, 2, false);
    if (count < 0){
    ...
    i2c_write_blocking(_i2c, ADDRESS_SLAVE_MFRC522, buf2, 2, false);

    // Get the version of the MFRC522
    count = i2c_write_blocking(_i2c, ADDRESS_SLAVE_MFRC522, (uint8_t *)VersionReg, 1, true);
    count = i2c_read_blocking(_i2c, ADDRESS_SLAVE_MFRC522, &nfc->version, 1, false);
    if (count < 0){
    ...
    count = i2c_write_blocking(_i2c, ADDRESS_SLAVE_MFRC522, (uint8_t *)FIFOLevelReg, 1, true);
    count = i2c_read_blocking(_i2c, ADDRESS_SLAVE_MFRC522, &nfc->nbf, 1, false);
    if (count < 0){
